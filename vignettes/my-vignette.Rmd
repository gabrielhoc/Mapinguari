...
ggmap::ggmap(Fulanus_big) +
  ggplot2::geom_point(data = FulanusDistribution, mapping = ggplot2::aes(x = Lon, y = Lat), size = 1, colour = 'red')
```
...
```{r}
# Let's say we are only interested on the periods when performance is bigger than 200.

PhenFUN2 <- function(x) ifelse(x > 200, 1, 0)
...
**This is a theoretical description of the package from my thesis proposal, I need to update function names, format the formulas and citations, etc**
