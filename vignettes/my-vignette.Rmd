...
*Fulanus beltranus* is a fictional species of flowering plant from central Africa. We would like to find out how this species is going to do in different climate change scenarios. First let's look at the points where it is currently known to occurr. To access the distribution data, we must load package Mapinguari.
...
How does the climate looks like in this area? We can use function `Ecology` to extract WorldClim surfaces for that area.
...
image: ![](/Users/gabriel/Documents/Mapinguari-development/man/folder_organization.png)
